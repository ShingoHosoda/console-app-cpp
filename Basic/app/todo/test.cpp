...
void TestSortAsc()
{
  std::cout << "テスト開始" << std::endl;
  std::vector<app::Todo> todos1{
      {"01234567-00000007", "タイトル7", "2025-03-10", 0},
      {"01234567-00000006", "タイトル6", "2025-03-10", 0},
      {"01234567-00000005", "タイトル5", "2025-03-10", 0},
      {"01234567-00000004", "タイトル4", "2025-03-25", 0},
      {"01234567-00000003", "タイトル3", "2025-03-20", 0},
      {"01234567-00000002", "タイトル2", "2025-03-15", 0},
      {"01234567-00000001", "タイトル1", "2025-03-10", 0},
      {"01234567-00000000", "タイトル0", "2025-03-10", 0},
  };

  app::sortByAsc(todos1);

  std::vector<app::Todo> todos2{
      {"01234567-10000000", "タイトル0", "2025-03-10", 0},
      {"01234567-10000001", "タイトル1", "2025-03-10", 0},
      {"01234567-10000002", "タイトル2", "2025-03-15", 0},
      {"01234567-10000003", "タイトル3", "2025-03-20", 0},
      {"01234567-10000004", "タイトル4", "2025-03-25", 0},
      {"01234567-10000005", "タイトル5", "2025-03-10", 0},
      {"01234567-10000006", "タイトル6", "2025-03-10", 0},
      {"01234567-10000007", "タイトル7", "2025-03-10", 0},
  };
